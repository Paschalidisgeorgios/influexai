        ...
        <div className="mx-auto max-w-[720px] rounded-2xl border border-white/[0.08] bg-white/[0.02] px-6 py-10 text-center md:px-12 md:py-14">
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            <AcidMotionButton
              ...
              className="btn-acid min-h-[48px] w-full justify-center sm:w-auto"
            >
              {t("cta_primary")}
            </AcidMotionButton>
            <Link
              href="/pricing"
              className="inline-flex min-h-[48px] w-full items-center justify-center rounded-lg border border-white/[0.14] px-5 py-2.5 text-sm font-semibold text-zinc-300 transition-colors hover:border-[#B4FF00]/35 hover:text-[#B4FF00] sm:w-auto"
            >
              {t("cta_secondary")}
            </Link>
          </div>
