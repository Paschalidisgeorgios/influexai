...
export function LandingHeroBackground() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
      ...
      <div className="absolute inset-0 bg-black/45 max-sm:bg-black/58" />
      <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/40 to-transparent max-sm:bg-gradient-to-b max-sm:from-black/88 max-sm:via-black/62 max-sm:to-black/45" />
