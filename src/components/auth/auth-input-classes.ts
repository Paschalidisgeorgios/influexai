...
export const authButtonClass =
  "w-full rounded-xl bg-[#ccff00] py-3.5 text-sm font-bold text-black transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(204,255,0,0.5)] disabled:cursor-not-allowed disabled:opacity-55 disabled:hover:scale-100 disabled:hover:shadow-none";

export const authLinkAccentClass =
  "font-medium text-white/65 transition-colors hover:text-[#ccff00]";
