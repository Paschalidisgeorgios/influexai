...
export const LANDING_V2_COPY = {
  ...
  hero: {
    ...
    headline: "Dein Studio für kampagnenfähige KI-Visuals.",
    headlineAlt: "Campaign-ready AI visuals, faster.",
    headlineLines: ["Dein Studio für", "kampagnenfähige", "KI-Visuals."] as const,
    primaryHeadlineFull: "Dein Studio für kampagnenfähige KI-Visuals.",
    ...
    subline:
      "Erstelle kampagnenfähige KI-Visuals, UGC-Videos und Content-Assets schneller — mit einem Studio für Creator, Marken und Agenturen.",
  ...
  finalCta: {
    headline: "Starte mit InfluexAI Creator Studio.",
    subline:
      "Erstelle kampagnenfähige KI-Visuals und Content-Assets schneller — für Creator, Marken und Agenturen.",
    ctaPrimary: "Studio starten",
    ctaSecondary: "Preise ansehen",
  },
} as const;
