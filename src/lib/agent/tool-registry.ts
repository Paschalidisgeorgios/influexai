...
export const AGENT_TOOL_REGISTRY: readonly AgentToolRegistryItem[] = [
  ...
  },
  {
    ...
    description:
      "KI-Kampagnenplaner mit Claude-Planung, Tool-Ausführung und Content-Enrichment.",
    canDo: [
      "Multi-Step Kampagnenplan",
      "Hooks, Scripts, Kalender, Visuals",
      "Captions, Hashtags, Posting-Zeiten",
      "Job Queue für große Kampagnen",
    ],
    cannotDo: [
      "Echte Posts veröffentlichen",
      "Autonomes Publishing ohne Freigabe",
    ],
    requiredInputs: ["campaignBrief"],
    optionalInputs: ["mode", "platform", "tone", "goal"],
    outputType: "mixed",
    creditCost: {
      type: "variable",
      min: 20,
    ...
    autoRunAllowed: true,
    notes: [
      "executeRealCampaign via campaignExecutor.ts",
