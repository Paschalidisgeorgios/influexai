...
export const TOOL_API_SCHEMA: Record<string, ToolApiDefinition> = {
  ...
  "produkt-werbung": {
    ...
    params: [
      ...
      },
      {
        ...
        label: "Zielgruppe",
        type: "string",
        placeholder: "z.B. Fitness-Enthusiasten 25–35",
      },
      {
        key: "plattform",
        label: "Plattform",
  ...
  "flux-image": {
    ...
    description: "KI-Bildgenerierung — Krea AI & Flux via Fal AI.",
    accent: "#8B5DFF",
    ...
    params: [
      { key: "prompt", label: "Beschreibung", type: "textarea", required: true },
      {
        ...
        type: "select",
        required: true,
        defaultValue: "krea/v2/large/text-to-image",
        options: [
          {
            value: "krea/v2/large/text-to-image",
            label: "Krea 2 Large — Photorealistisch",
          },
          {
            value: "krea/v2/medium/text-to-image",
  ...
  "lora-training": {
    id: "lora-training",
    label: "KI-Klon Training",
    icon: "🎨",
    category: "VISUALS",
    dashboardRoute: "/dashboard/lora-training",
    outputType: "train",
    baseCoins: CANVAS_TOOL_BASE_COINS["lora-training"],
    description: "Trainiere deinen persönlichen KI-Klon für einen wiedererkennbaren Look.",
    accent: "#FFD84D",
    accentRgb: "255,216,77",
    ...
    params: [
      { key: "klon_name", label: "Klon-Name", type: "string", required: true, placeholder: "z.B. Mein Creator-Klon" },
      { key: "dataset_zip", label: "Dataset (ZIP)", type: "file", required: true, placeholder: "10–30 Fotos als ZIP hochladen" },
      { key: "trigger_word", label: "Erkennungswort", type: "string", required: true, placeholder: "z.B. MEINLOOK" },
  ...
  "thumbnail-concept": {
    ...
    apiRoute: "/api/thumbnail-concept",
    params: [
      {
        key: "topic",
        label: "Video-Titel / Thema",
        type: "textarea",
        required: true,
        placeholder: "z.B. Ich habe 30 Tage nur KI-Tools genutzt — das passierte",
      },
      {
        key: "style",
        label: "Thumbnail-Stil",
        type: "select",
        required: true,
        defaultValue: "face_emotion",
        options: [
          { value: "face_emotion", label: "Gesicht + Emotion" },
          { value: "text_dominant", label: "Text-dominant" },
          { value: "before_after", label: "Vorher / Nachher" },
          { value: "curiosity_gap", label: "Neugier-Gap" },
          { value: "list_number", label: "Liste / Zahl" },
          { value: "shock_value", label: "Schock-Wert" },
        ],
      },
      {
        key: "color_energy",
        label: "Farb-Energie",
        type: "select",
        defaultValue: "acid_viral",
        options: [
          { value: "warm", label: "Warm & Energetisch" },
          { value: "cool_premium", label: "Cool & Premium" },
          { value: "acid_viral", label: "Acid & Viral (Neon)" },
          { value: "minimal", label: "Minimalistisch" },
        ],
      },
      {
        key: "reference_image",
        label: "Referenz-Thumbnail (optional)",
        type: "file",
        placeholder: "PNG oder JPG — als Stil-Vorlage",
      },
    ],
  },
  "niche-analyzer": {
    ...
    apiRoute: "/api/niche-analyzer",
    params: [
      {
        key: "topic",
        label: "Interesse / Ausgangsthema",
        type: "textarea",
        required: true,
        placeholder: "z.B. KI-Tools für Creator, Nachhaltige Mode, Fitness zu Hause",
      },
      {
        key: "audience",
        label: "Zielgruppe",
  ...
  "outlier-detector": {
    ...
    params: [
      {
        key: "niche",
        label: "Nische / Themenfeld",
        type: "string",
        required: true,
        placeholder: "z.B. Produktivität, Krypto, Fitness",
      },
      {
        key: "period",
        label: "Zeitraum",
        type: "select",
        defaultValue: "Letzter Monat",
        options: [
          { value: "Letzte 7 Tage", label: "Letzte 7 Tage" },
          { value: "Letzter Monat", label: "Letzter Monat" },
          { value: "Letztes Quartal", label: "Letztes Quartal" },
      ...
      },
      {
        ...
        defaultValue: "Alle",
        options: [
          { value: "Nano (< 10K)", label: "Nano (< 10K)" },
          { value: "Micro (10K-100K)", label: "Micro (10K–100K)" },
          { value: "Mid (100K-1M)", label: "Mid (100K–1M)" },
    ...
    params: [
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Füge dein komplettes Sprecher-Skript ein (mind. 20 Zeichen)",
      },
      {
        key: "thumbnail_idea",
        ...
        type: "textarea",
        required: true,
        placeholder: "z.B. Großes Gesicht links, Text „30 Tage KI“ in Neon-Gelb",
      },
      {
        key: "niche",
        label: "Nische",
        type: "string",
        required: true,
        placeholder: "z.B. Tech, Fitness, Finanzen",
      },
      {
        key: "language",
  ...
  "ugc-video": {
    id: "ugc-video",
    label: "UGC Produktvideo",
    icon: "🎬",
    category: "VIDEO & FILM",
    dashboardRoute: "/dashboard/ugc-video",
    outputType: "video",
    baseCoins: CANVAS_TOOL_BASE_COINS["ugc-video"],
    description: "Bild-zu-Video mit Kling, Seedance & Minimax — Produktfoto als Referenz.",
    accent: "#B7FF00",
    accentRgb: "183,255,0",
    outputDescription: "KI-Produktvideo",
    followUpTools: ["video-transformer", "video-uebersetzer", "lipsync-studio"],
    apiRoute: "/api/seedance",
    params: [
      {
        ...
        required: true,
        placeholder:
          "z.B. Das Produkt gleitet sanft ins Bild, Kamerafahrt von links, warm beleuchtet",
      },
      {
        key: "modelId",
        label: "Modell",
      ...
      {
        key: "images_list",
        label: "Referenzbild / Produktfoto",
        type: "file-list",
        required: true,
        acceptsOutputTypes: ["image"],
        placeholder: "PNG, JPG oder WebP — Produktfoto als Startframe",
      },
      {
        key: "duration",
        label: "Dauer (Sek.)",
      ...
      {
        key: "resolution",
        label: "Seitenverhältnis / Auflösung",
        type: "select",
        defaultValue: "720p",
        options: [],
      },
  ...
  "campaign-autopilot": {
    ...
    params: [
      {
        key: "campaign_brief",
        label: "Kampagnen-Briefing",
        type: "textarea",
        required: true,
        placeholder:
          "Beschreibe Produkt, Zielgruppe und was die Kampagne erreichen soll…",
      },
      {
        key: "mode",
        label: "Zeitraum",
        ...
        options: [
          ...
          { value: "weekly", label: "7 Tage Woche" },
          { value: "monthly", label: "30 Tage Monat" },
          { value: "product_launch", label: "Produktkampagne" },
        ],
      },
      {
        key: "platforms",
      ...
      },
      {
        ...
        options: [
          ...
          { value: "trustworthy", label: "Vertrauensvoll" },
          { value: "bold", label: "Frech / Bold" },
        ],
      },
    ],
  },
