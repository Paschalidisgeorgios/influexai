-- Core generations table + result JSON + RLS (migrations 002, 032, 008, 041 columns)
-- Idempotent — run if createGenerationRecord fails with 404 / missing column.
...
-- credit_transactions (paired with generations in 002)
