-- Platform tables — paste into Supabase SQL Editor (project: hszjafdelcydnppyolkm)
-- Fixes 404 on announcements, platform_settings, daily_suggestions, push_notifications.
-- Idempotent — safe to run multiple times.

-- (full SQL: same as supabase/migrations/044_ensure_platform_tables.sql)
