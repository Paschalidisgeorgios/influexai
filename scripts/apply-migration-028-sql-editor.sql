-- =============================================================================
-- InfluexAI Migration 028 — Run in Supabase Dashboard → SQL Editor → Run
-- Project: hszjafdelcydnppyolkm (https://supabase.com/dashboard/project/hszjafdelcydnppyolkm/sql/new)
